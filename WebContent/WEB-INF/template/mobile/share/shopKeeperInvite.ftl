...
<html>
	...
	<body>
		<header class="header">
		  ...
		  <div class="header-c">${tenantName }邀您开通店长</div>
		...
		<div class="container top-mg50">
			...
			<div class="banner">
				...
				<div class="banner-Text">
					<dl><dt><s><img src="${tenantLogo }"/></s></dt><dd><h1>${shopKeeper.name }</h1><h2>${tenantName }的员工们、尊贵的店长们：要感谢有我，因为有我，你才有机会成为${tenantName }内购店长，动动手指月入过万！</h2></dd></dl>
				</div>
			</div>
			<!---->
			<div class="Shop-body">
		   ...
		   //弹出窗口
			...
			function ajaxget(){
				...
				$.ajax({
					type:"POST",
					data:mbinput,
					url:"${base}/invitation/shopKeeperInvite.jhtml",					
					dataType: 'json',
					success: function(data){
						//alert("正确"+data.responseText);
