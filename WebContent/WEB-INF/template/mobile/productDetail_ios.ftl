    ...
    [/@compress]
		...
		<div class="container ">
			<div class="swiper-container swiper-container-horizontal">
		        <div class="swiper-wrapper">
		        	[#list product.productImages as item]
		        		[#if item_index == 0]
							<div class="container swiper-slide swiper-slide-active" style="width: 100%;"><img width="100%" src="${item.large}"></div>	        		
		        		[#else]
		        			<div class="container  swiper-slide swiper-slide-next" style="width: 100%;"><img width="100%"  src="${item.large}"></div>
		        		[/#if]
		        	[/#list]
		        </div>
		        <!-- banner上的圆点 -->
			...
			<div class="Product-details-Purchase top-line">
				<h1><span class="Product-se">商品信息</span><span onclick="document.location='testapp:shop:backPrePage';">进入内购店首页</span></h1>
				<h2 onclick="document.location='testapp:shop:couponsTip';"><span >内购券</span>单笔订单购买商品越多省钱越多</h2>
			</div>
...
<!-- 		<button class="scrollToBtn" onclick="comeHere()">222</button> -->
		<!--返回顶部-->
