    ...
    <script type="text/javascript">
		...
		[@flash_message /]
            ...
            $export.click(function() {
                listForm.action="recommendChargeMonthExportExcel.jhtml";
                listForm.submit();
                   listForm.action="recommendChargeListMonthReport.jhtml";
            });
...
<div class="path">
    <a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; 邀请奖金报表 <span></span>
</div>
<form id="listForm" action="recommendChargeListMonthReport.jhtml" method="get">
    ...
    <div style="height:30px"><span>邀请奖金合计金额： ${currency(totalSettleCharge, true)}</span> </div>
    <table id="listTable" class="list">
        <tr>
            ...
            <th>
                <a href="javascript:;" class="sort" name="orderStatus">关联店长销售总金额（¥）</a>
            </th>
            <th>
                <a href="javascript:;" class="sort" name="tenant">邀请奖金金额（¥）</a>
            </th>
            <th>
