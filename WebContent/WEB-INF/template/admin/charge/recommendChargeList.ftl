    ...
    <script type="text/javascript">
		...
		[@flash_message /]
            ...
            $export.click(function() {
                listForm.action="recommendExport.jhtml";
                listForm.submit();
                   listForm.action="recommendChargeList.jhtml";
            });
...
<div class="path">
    <a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; 邀请奖金明细 <span></span>
</div>
<form id="listForm" action="recommendChargeList.jhtml" method="get">
    ...
    <div>
        ...
        [/#list]
            ...
            <option value="2" [#if ("2" == orderStatusParam)] selected[/#if] >已结算</option>
 			...
 			<option value="4" [#if ("4" == orderStatusParam)] selected[/#if] >已发放</option>
        </select>
    ...
    <div style="height:30px"><span>&nbsp;邀请奖金合计金额： ${currency(totalAmount, true)}</span> </div>
    <table id="listTable" class="list">
        <tr>
            ...
            <th>
             ...
             <th>
                <a href="javascript:;" class="sort" name="member">受邀请的店长</a>
            </th>
            <th>
                <a href="javascript:;" class="sort" name="consignee">受邀请店长手机号</a>
            </th>
            <th>
	...
	[#list page.content as order]
        <tr>
            ...
            <td>
            ${currency(order.recommonAmount, true)}
            </td>
            <td>
			${order.statusName}
            </td>
