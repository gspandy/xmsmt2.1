    ...
    <script type="text/javascript">
		...
		[@flash_message /]
            ...
            $export.click(function() {
                listForm.action="shareChargeMonthExportExcel.jhtml";
                listForm.submit();
                  listForm.action="shareChargeMonthReport.jhtml";
            });
...
<div class="path">
    <a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; 分享佣金报表 <span></span>
</div>
<form id="listForm" action="shareChargeMonthReport.jhtml" method="get">
    ...
    <div>
        <div style="margin:10px">
            ...
            提现状态：&nbsp;<select name="orderStatusParam" style="width:140px">
            <option value="">--请选择--</option>
            <option value="0"  [#if ("0" == orderStatusParam)] selected[/#if]>未申请</option>
           
            <option value="1" [#if ("1" == orderStatusParam)] selected[/#if] >提现审核中</option>
            <option value="2"  [#if ("2" == orderStatusParam)] selected[/#if]>已提现</option>
        </select>
            ...
            店长手机号：<input type="text" name="mobile" class="text" value="${mobile}"  />
      ...
      [#--  <div style="margin:10px">
            ...
            <input type="submit" class="button" value="搜索" />
            	<input type="button" id="excelDetail" class="button" value="导出报表"  style="height:28px;"/>
            	<input type="button" id="excel" class="button" value="导出本月报表"  style="height:28px;"/>
    ...
    <table id="listTable" class="list">
        <tr>
            ...
            <th>
              ...
              <th>
                <a href="javascript:;" class="sort" name="member">结算月份</a>
            </th>
            <th>
                <a href="javascript:;" class="sort" name="member">店长姓名</a>
            </th>
            <th>
                <a href="javascript:;" class="sort" name="consignee">手机号</a>
            </th>
            <th>
                <a href="javascript:;" class="sort" name="orderStatus">订单总金额（¥）</a>
            </th>
            <th>
                <a href="javascript:;" class="sort" name="tenant">分享佣金金额（¥）</a>
            </th>
            <th>
                <a href="javascript:;" class="sort" name="tenant">提现状态</a>
            </th>
