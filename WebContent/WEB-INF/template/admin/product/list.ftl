	...
	<form id="listForm" action="list.jhtml" method="get">
		...
		<div class="bar">
			...
			<div class="buttonWrap">
				...
				<input type="button" class="button" onclick="soldOut()" value="下架" style="height:28px" />
			</div>
			<div class="menuWrap">
				<div class="search">
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="name">规格</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="productCategory">${message("Product.productCategory")}</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="price">内购价</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="ePrice">电商价</a>
				</th>
				<th>
