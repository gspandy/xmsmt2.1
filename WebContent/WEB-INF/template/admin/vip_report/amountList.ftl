...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="path">
			<a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; Vip销售额统计 <span>(${message("admin.page.total", page.total)})</span>
		</div>
		<form id="listForm" action="amountList.jhtml" method="get">
			<div class="bar">
			...
			<table id="listTable" class="list">
				...
				[#list page.content as vipReport]
					<tr>
						...
						<td>
							${currency(vipReport.amount, true)}
						</td>
						<td>
							<a href="amountView.jhtml?id=${vipReport.vipId}&beginDate=${beginDate}&endDate=${endDate}">查看订单明细</a>
						</td>
					</tr>
				[/#list]
			</table>
