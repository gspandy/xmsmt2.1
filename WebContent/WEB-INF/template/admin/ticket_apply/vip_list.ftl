...
$().ready(function() {
	...
	$filterSelect.mouseover(function() {
	 ...
	 $search.click(function() {
   		  listForm.action="vip_list.jhtml";
	      listForm.submit();
      });
...
<body>
	<div class="path">
		<a href="${base}/admin/ticketApply/list.jhtml">${message("admin.path.index")}</a> &raquo; 店长申请内购券 <span>(${message("admin.page.total", page.total)})</span>
	</div>
	<form id="listForm" action="${base}/admin/ticketApply/list.jhtml" method="get">
		<input type="hidden" name="applyTypeParam" value="shopkeeperApply" />
		<div>
			<div style="margin:10px">
			店长手机号：&nbsp;<input type="text" id="mobile" name="mobile" class="text" value="${mobile}"  />&nbsp;&nbsp;
		...
		<table id="listTable" class="list">
			...
			[#list page.content as ticketApply]
				<tr>
					...
					<td>
						${ticketApply.owner.name}
					</td>
					<td>
						${ticketApply.owner.mobile}
					</td>
					<td>
					...
					[#if ticketApply.applyStatus == 'apply']
						<td>
							<a href="${base}/admin/ticketApply/agree.jhtml?ids=${ticketApply.id}&applyTypeParam=shopkeeperApply">[同意]</a>&nbsp;
