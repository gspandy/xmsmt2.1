...
public class CompleteExcelView extends AbstractExcelView {
	...
	public CompleteExcelView(String filename, Collection<net.wit.entity.Order> data) {
	...
	protected void buildExcelDocument(Map<String, Object> model, HSSFWorkbook workbook, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		headercell18.setCellValue("申请退货时间");
